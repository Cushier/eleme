...
namespace eleme
{
    ...
    public partial class Form1 : Form
    {
            ...
            if (sn == "")
            {
                ...
                if (listView1.Items.Count < Packets_number)
                {
                    ...
                    for (int i = 0; i < listView1.Items.Count; i++) {
                        ...
                        {
                            MessageBox.Show("当前红包总数量为" + Packets_number + "已领取数量" + number2 + "请您手动领取最大手气红包");
                            break;
                        }
                        ...
                        if (i+1 == listView1.Items.Count) {
                            MessageBox.Show("当前红包总数量为" + Packets_number + "已领取数量" + number2 );
                        }
                    }
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/hibeiche/eleme/tree/master");
